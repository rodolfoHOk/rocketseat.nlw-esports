...
import { Toast, ToastInfos, ToastViewport } from './Toast';
...
export function CreateAdModal() {
  ...
  const [toastInfos, setToastInfos] = useState<ToastInfos>({
    variant: 'error',
    title: 'Erro',
    description: '',
  });
    ...
    createAd(adDto.game, {
      ...
      .catch((err) => {
        ...
        setToastInfos({
          variant: 'error',
          title: 'Erro',
          description: 'Erro ao tentar criar o anúncio',
        });
        setOpenToast(true);
      });
  }
  ...
  return (
    <>
      ...
      <Toast
        ...
        variant={toastInfos.variant}
        title={toastInfos.title}
        description={toastInfos.description}
      />
      <ToastViewport />
    </>
  );
